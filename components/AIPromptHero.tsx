    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-900 via-slate-900 to-purple-950 p-6 md:p-8 text-white shadow-2xl border border-indigo-500/30 mb-8">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs font-medium">
          <span className="text-slate-400 font-semibold">{t.quickShortcuts}</span>
          ...
          >
            ...
            <span>{criticalAlertCount} {t.criticalAlertsCount}</span>
          </button>

          <button
            type="button"
            onClick={() => handleQuickChip(t.khdaReportQuery)}
